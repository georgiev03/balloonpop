class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.balloonScale = isMobile ? 1.4 : 0.6; // Increased mobile scale to 1.4
    ...
    createBalloonsForRound() {
        ...
        const isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);
        const spacing = isMobile ? 160 : 200; // Reduced spacing for mobile
    ...
    createBalloon(x, y, word) {
        ...
        const isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);
        const textScale = isMobile ? 0.8 : 0.9; // Adjusted text scale for mobile
        ...
        const hitAreaScale = isMobile ? 1.2 : 1.0; // Larger hit area for mobile
